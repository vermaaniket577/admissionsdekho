...
<body class="font-sans antialiased bg-slate-50 text-slate-900 flex flex-col min-h-screen" 
      x-data="{ isModalOpen: false, modalTitle: 'Get Free Admission Counselling', selectedCourse: '', mobileMenuOpen: false }"
    ...
    <section class="py-16 sm:py-20 bg-slate-900 text-white border-t border-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-12 sm:mb-16 border-b border-slate-800 pb-12">
                <div class="lg:col-span-7 space-y-3 text-center lg:text-left">
                    <span class="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/30 text-amber-400 font-extrabold text-xs uppercase tracking-wider px-3.5 py-1.5 rounded-full">
                ...
                <!-- Rating Scoreboard -->
                <div class="lg:col-span-5 flex flex-col sm:flex-row items-center justify-center lg:justify-end gap-6 bg-slate-950/80 p-6 rounded-3xl border border-slate-800 shadow-xl">
                    <div class="text-center">
                        <div class="text-4xl sm:text-5xl font-black text-amber-400">4.9 <span class="text-xl text-slate-400 font-bold">/ 5.0</span></div>
                        <div class="flex items-center justify-center gap-1 text-amber-400 text-lg mt-1">
                            ★★★★★
                        </div>
                        <p class="text-xs text-slate-400 mt-1 font-semibold">5,420+ Verified Reviews</p>
                    </div>
                    <div class="hidden sm:block h-16 w-px bg-slate-800"></div>
                    <div class="space-y-1.5 text-xs text-slate-300 font-semibold text-center sm:text-left">
                        <div class="flex items-center gap-2">
            ...
            <div class="overflow-hidden relative w-full py-4 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                ...
                <div class="absolute top-0 bottom-0 left-0 w-12 sm:w-24 bg-gradient-to-r from-slate-900 to-transparent z-10 pointer-events-none"></div>
                <div class="absolute top-0 bottom-0 right-0 w-12 sm:w-24 bg-gradient-to-l from-slate-900 to-transparent z-10 pointer-events-none"></div>

                <div class="animate-reviews-ticker flex items-stretch gap-6 cursor-pointer">

                    <!-- LOOP SET 1 -->
                    <!-- Review 1 -->
                    <div class="w-[300px] sm:w-[380px] shrink-0 bg-slate-950/90 p-6 rounded-3xl border border-slate-800 hover:border-amber-500/60 hover:scale-[1.02] transition-all space-y-4 flex flex-col justify-between shadow-xl">
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                <div class="flex items-center gap-1 text-amber-400 text-sm font-bold">
                                    ★★★★★
                                </div>
                                <span class="text-[10px] font-bold uppercase tracking-wider text-emerald-400 bg-emerald-950/80 px-2 py-0.5 rounded border border-emerald-800/80">Verified Student</span>
                            </div>
                        ...
                        <div class="flex items-center gap-3 pt-3 border-t border-slate-800/80">
                            <div class="w-10 h-10 rounded-full bg-blue-600/30 border border-blue-500/40 text-blue-300 font-extrabold flex items-center justify-center text-sm shrink-0">
                                RS
                            </div>
                            <div>
                                <h4 class="text-xs sm:text-sm font-bold text-white">Rohan Sharma</h4>
                                <p class="text-[11px] text-slate-400">Admitted to B.Tech Computer Science</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-[300px] sm:w-[380px] shrink-0 bg-slate-950/90 p-6 rounded-3xl border border-slate-800 hover:border-amber-500/60 hover:scale-[1.02] transition-all space-y-4 flex flex-col justify-between shadow-xl">
                        ...
                        <div class="flex items-center gap-3 pt-3 border-t border-slate-800/80">
                            <div class="w-10 h-10 rounded-full bg-purple-600/30 border border-purple-500/40 text-purple-300 font-extrabold flex items-center justify-center text-sm shrink-0">
                                AV
                            </div>
                            <div>
                                <h4 class="text-xs sm:text-sm font-bold text-white">Ananya Verma</h4>
                                <p class="text-[11px] text-slate-400">Admitted to BA LLB (5-Year Integrated)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-[300px] sm:w-[380px] shrink-0 bg-slate-950/90 p-6 rounded-3xl border border-slate-800 hover:border-amber-500/60 hover:scale-[1.02] transition-all space-y-4 flex flex-col justify-between shadow-xl">
                        ...
                        <div class="flex items-center gap-3 pt-3 border-t border-slate-800/80">
                            <div class="w-10 h-10 rounded-full bg-emerald-600/30 border border-emerald-500/40 text-emerald-300 font-extrabold flex items-center justify-center text-sm shrink-0">
                                PN
                            </div>
                            <div>
                                <h4 class="text-xs sm:text-sm font-bold text-white">Priya Nair</h4>
                                <p class="text-[11px] text-slate-400">Admitted to B.Sc Nursing</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-[300px] sm:w-[380px] shrink-0 bg-slate-950/90 p-6 rounded-3xl border border-slate-800 hover:border-amber-500/60 hover:scale-[1.02] transition-all space-y-4 flex flex-col justify-between shadow-xl">
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-[10px] font-bold uppercase tracking-wider text-emerald-400 bg-emerald-950/80 px-2 py-0.5 rounded border border-emerald-800/80">Verified Aspirant</span>
                            </div>
                            <p class="text-xs sm:text-sm text-slate-300 leading-relaxed italic">
                        ...
                        <div class="flex items-center gap-3 pt-3 border-t border-slate-800/80">
                            <div class="w-10 h-10 rounded-full bg-amber-600/30 border border-amber-500/40 text-amber-300 font-extrabold flex items-center justify-center text-sm shrink-0">
                                AG
                            </div>
                            <div>
                                <h4 class="text-xs sm:text-sm font-bold text-white">Aditya Gupta</h4>
                                <p class="text-[11px] text-slate-400">Admitted to MBA (Business Analytics)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-[300px] sm:w-[380px] shrink-0 bg-slate-950/90 p-6 rounded-3xl border border-slate-800 hover:border-amber-500/60 hover:scale-[1.02] transition-all space-y-4 flex flex-col justify-between shadow-xl">
                        ...
                        <div class="flex items-center gap-3 pt-3 border-t border-slate-800/80">
                            <div class="w-10 h-10 rounded-full bg-rose-600/30 border border-rose-500/40 text-rose-300 font-extrabold flex items-center justify-center text-sm shrink-0">
                                KP
                            </div>
                            <div>
                                <h4 class="text-xs sm:text-sm font-bold text-white">Kavya Patel</h4>
                                <p class="text-[11px] text-slate-400">Admitted to B.Pharm</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-[300px] sm:w-[380px] shrink-0 bg-slate-950/90 p-6 rounded-3xl border border-slate-800 hover:border-amber-500/60 hover:scale-[1.02] transition-all space-y-4 flex flex-col justify-between shadow-xl">
                        ...
                        <div class="flex items-center gap-3 pt-3 border-t border-slate-800/80">
                            <div class="w-10 h-10 rounded-full bg-indigo-600/30 border border-indigo-500/40 text-indigo-300 font-extrabold flex items-center justify-center text-sm shrink-0">
                                SM
                            </div>
                            <div>
                                <h4 class="text-xs sm:text-sm font-bold text-white">Siddharth Mehta</h4>
                                <p class="text-[11px] text-slate-400">Admitted to BCA (Software Development)</p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Footer -->
    <footer class="bg-[#0B0F19] text-slate-300 text-sm mt-0 border-t border-slate-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10">
                ...
                <div class="space-y-4 lg:col-span-1">
                    ...
                    <div class="flex items-center gap-2.5 pt-3">
                        <!-- LinkedIn -->
                        <a href="https://linkedin.com/company/admissionsdekho" target="_blank" aria-label="LinkedIn"
                        ...
                        <!-- Facebook -->
                        <a href="https://facebook.com/admissionsdekho" target="_blank" aria-label="Facebook"
                        ...
                        <!-- Instagram -->
                        <a href="https://instagram.com/admissionsdekho" target="_blank" aria-label="Instagram"
                        ...
                        <!-- YouTube -->
                        <a href="https://youtube.com/@admissionsdekho" target="_blank" aria-label="YouTube"
                        ...
                        <!-- WhatsApp -->
                        <a href="https://wa.me/919643802216" target="_blank" aria-label="WhatsApp"
